<?php
	session_start();
	$_SESSION["mdp"] = mysqli_real_escape_string($id_bd, $_REQUEST["mdp"]);  // recovering password from login_gestionnaire form
	$motdep = $_SESSION["mdp"];
	$_SESSION["login"] = mysqli_real_escape_string($id_bd, $_REQUEST["login"]);  // recovering username from login_gestionnaire form
